  ...
  return (
    <>
      ...
      <main className="w-11/12 mx-auto max-w-[1200px]">
        <aside className="">
          <h1 className="font-black text-4xl text-softBlue">Marco Fernández</h1>
          <p className="">Jr Full Stack Developer (MERN, MEVN)</p>
          <p className="">Industrial Administrator</p>
          <p className="">
            <span className=""> &lt;make&gt;</span> it happen
