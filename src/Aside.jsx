        ...
        <div className="space-y-3 w-full md:w-2/3">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <img src={ts} alt="html" srcset="" className="h-8" />
              <img src={react} alt="html" srcset="" className="h-8" />
              <img src={vue} alt="html" srcset="" className="h-8" />
              <img src={mongo} alt="html" srcset="" className="h-8" />
              <img src={postgres} alt="html" srcset="" className="h-12" />
